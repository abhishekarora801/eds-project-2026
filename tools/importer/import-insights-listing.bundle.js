...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-insights-listing.js
  var import_insights_listing_exports = {};
  __export(import_insights_listing_exports, {
    default: () => import_insights_listing_default
  });
  ...
  var PAGE_TEMPLATE = {
    ...
    "description": "Insights listing: hero intro, featured article, article-card grid, image gallery, accent CTA",
    "urls": [
    ...
    "blocks": [
      ...
      },
      {
        "name": "cards-gallery",
        "instances": [
          "#main-content > section.section:nth-of-type(3) .grid-layout.grid-gap-sm"
        ]
      }
    ],
    "sections": [
  ...
  var import_insights_listing_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_insights_listing_exports);
})();
